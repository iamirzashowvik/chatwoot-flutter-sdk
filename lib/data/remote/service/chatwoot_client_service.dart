...
class ChatwootClientServiceImpl extends ChatwootClientService {
  ...
  Future<ChatwootMessage> createMessage(
    ...
    try {
      ...
      throw ChatwootClientException(
         e.message??"smthng went wrong", ChatwootClientExceptionType.SEND_MESSAGE_FAILED);
    }
  }
  ...
  Future<List<ChatwootMessage>> getAllMessages() async {
    try {
      ...
      throw ChatwootClientException(
         e.message??"smthng went wrong", ChatwootClientExceptionType.GET_MESSAGES_FAILED);
    }
  }
  ...
  Future<ChatwootContact> getContact() async {
    try {
      ...
      throw ChatwootClientException(
         e.message??"smthng went wrong", ChatwootClientExceptionType.GET_CONTACT_FAILED);
    }
  }
  ...
  Future<List<ChatwootConversation>> getConversations() async {
    try {
      ...
      throw ChatwootClientException(
         e.message??"smthng went wrong", ChatwootClientExceptionType.GET_CONVERSATION_FAILED);
    }
  }
  ...
  Future<ChatwootContact> updateContact(update) async {
    try {
      ...
      throw ChatwootClientException(
         e.message??"smthng went wrong", ChatwootClientExceptionType.UPDATE_CONTACT_FAILED);
    }
  }
  ...
  Future<ChatwootMessage> updateMessage(
    ...
    try {
      ...
      throw ChatwootClientException(
         e.message??"smthng went wrong", ChatwootClientExceptionType.UPDATE_MESSAGE_FAILED);
    }
  }
